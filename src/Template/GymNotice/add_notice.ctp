...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<div class="col-md-6">
			<input type="text" name="start_date" class="date form-control validate[required]" value="<?php echo ($edit)?date($this->Gym->getSettings("date_format"),strtotime($data["start_date"])): "";?>">
		</div>	
		</div>
		...
		<div class="col-md-6">
			<input type="text" name="end_date" class="date form-control validate[required]" value="<?php echo ($edit)?date($this->Gym->getSettings("date_format"),strtotime($data["end_date"])) : "";?>">
		</div>	
		</div>
